...
- `MONGODB_DOCUMENT_COLLECTION=documents`: generated and uploaded document metadata.
- `MONGODB_FILE_BUCKET=admin_files`: GridFS bucket used for document and correspondence attachment content.
